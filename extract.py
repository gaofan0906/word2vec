...
from network import get_vector
...
# 将文本转化为300维的特征
def getVocabulary(data_dirs, document_length_limit, is_line_as_word, dev_sample_percentage):
...
def preprocess(data_dirs, document_length_limit, is_line_as_word, dev_sample_percentage):
    ...
    print("Vocabulary Size: {:d}".format(len(vocab_processor.vocabulary_)))
    print("Train/Dev split: {:d}/{:d}".format(len(y_train), len(y_dev)))
    return x_dev, y_dev, vocab_processor, x_dev, y_dev


def train(x_train, y_train, vocab_processor,
    ...
    def train_step(x_batch, y_batch):
        ...
        print("[train_v1] {}: step {}, loss {}, acc {}".format(time_str, step, train_loss, train_accuracy))
...
def main():
    ...
    x_train, y_train, vocab_processor = getVocabulary(data_dirs,
                                                                 document_length_limit,
                                                                 is_line_as_word,
                                                                 dev_sample_percentage)
    print("==========================start train_v1===========================")
    train(x_train, y_train, vocab_processor,
